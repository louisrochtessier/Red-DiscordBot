...
class Insult:
    ...
    async def insult(self, ctx, user : discord.Member=None):
        ...
        msg = ' '
        if user != None:
            if user.id == "204411960274583553" or user.id == "182279276068864000":
                user = ctx.message.author
                msg = "we are the one who modified this code you ungrateful bitch, so don't you dare insult the developers hehehehe"
